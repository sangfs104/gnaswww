...
// // //   // Cập nhật số lượng (tối ưu: cập nhật FE trước, gọi API song song)
...
// // //     (total, item) =>
// // //       total + (item.product?.price || item.variant?.price || 0) * item.quantity,
// // //     0
// // //   );
...
//       variant.discountPrice < 1e6
//     ) {
//       return variant.discountPrice / 1000; // Convert VND to USD
//     }
//     return (variant?.price || 0) / 1000; // Fallback to price
//   };
...
//                 const originalPrice = (item.variant?.price || 0) / 1000;
//                 const isOnSale =
//                   item.variant?.discountPrice &&
//                   item.variant.discountPrice < item.variant.price &&
//                   item.variant.discountPrice < 1e6;
...
//                     <div className="col-span-3 text-right">
//                       <span className="font-medium text-base sm:text-lg">
//                         ${(effectivePrice * item.quantity).toFixed(2)} USD
//                       </span>
//                     </div>
//                   </div>
//                 );
