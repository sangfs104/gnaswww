...
const BANK_INFO = {
  ...
  accountNumber: "392179948",
  // accountHolder: "NGUYEN VAN A", // ← điền tên chủ TK nếu muốn hiện
  instagramHandle: "@sand.nas", // ← đổi handle thật
  instagramUrl: "https://www.instagram.com/sand.nas/", // ← đổi link thật
};
...
const CheckoutPage = () => {
  ...
  const handleCopySTK = async () => {
    try {
      ...
      el.value = BANK_INFO.accountNumber;
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <section className="checkout-card">
            ...
            {/* ===== Panel hướng dẫn chuyển khoản ===== */}
            {paymentMethod === "bank_transfer" && (
              <div className="mt-4 rounded-xl border border-[var(--line)] bg-[var(--paper)] overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex justify-between items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-semibold text-[var(--ink)] tracking-wide font-mono">
                        {BANK_INFO.accountNumber}
                      </span>
                      <button
                        type="button"
                        onClick={handleCopySTK}
                        className="text-[11px] font-medium px-2.5 py-1 rounded-md bg-[var(--accent-soft)] text-[var(--ink)] hover:opacity-80 transition-opacity"
                      >
                  ...
                  <div className="flex justify-between items-start gap-3">
                    <span className="text-xs text-[var(--muted)] shrink-0 pt-0.5">
                      Nội dung CK
                    </span>
                    <span className="text-sm text-[var(--ink)] text-right leading-snug">
                      [Họ tên] + SĐT đặt hàng
                    </span>
                  </div>
                  ...
                  {/* Hướng dẫn sau khi chuyển */}
                  <div className="rounded-lg bg-[var(--surface)] border border-[var(--line)] px-3 py-3 space-y-2">
                    <p className="text-xs font-semibold text-[var(--ink)]">
                      Sau khi chuyển khoản
                    </p>
                    <ol className="text-[11px] text-[var(--muted)] space-y-1.5 list-decimal list-inside leading-relaxed">
                      <li>Chụp màn hình biên lai / lịch sử giao dịch</li>
                      <li>
                        Gửi ảnh qua Instagram{" "}
                        <a
                          href={BANK_INFO.instagramUrl}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="font-semibold text-[var(--ink)] underline underline-offset-2"
                        >
                          {BANK_INFO.instagramHandle}
                        </a>
                      </li>
                      <li>Shop xác nhận và tiến hành đóng đơn cho bạn</li>
                    </ol>
                  </div>

                  <p className="text-[10px] text-[var(--muted)] leading-relaxed">
                    Đơn hàng sẽ được xử lý sau khi shop nhận được ảnh chuyển
                    khoản. Thời gian xác nhận thường trong giờ làm việc.
                  </p>
                </div>
              </div>
            )}
